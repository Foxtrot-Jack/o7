...
const starterSteps = [
  ...
  {
    id: 'bezels',
    title: 'The Bezel Buttons',
    text: 'Your screen is surrounded by 24 function buttons — the bezels. The top, right, bottom, and left edges each hold six buttons. They change automatically based on what you are doing: flying in-system, docked at a station, viewing the galaxy map, or on a planet surface. Press any button to open that screen. You can also press the F1–F24 keys on a keyboard. Long-press any button to reassign it.',
    target: { buttonId: 'settings' },
  },
  {
    id: 'galaxy',
    title: 'Galaxy Map',
    text: 'Press the [[galaxy]] bezel button (top bezel) to view the galaxy. Tap any star to select it, then plot a route — your ship jumps system to system. Fuel and jump range are checked automatically before each jump.',
    target: { buttonId: 'galaxy' },
  },
  {
    id: 'system',
    title: 'System View',
    text: 'Press the [[system]] bezel button (top bezel) to see planets and stations orbiting in real time. Drag to rotate, pinch or scroll to zoom. Tap any body to select it, then use Travel To Body to move your ship. Undiscovered bodies appear after running an FSS scan.',
    target: { buttonId: 'system' },
  },
  {
    id: 'fss',
    title: 'FSS Scanner',
    text: 'When you arrive in a new system, press the [[scanners]] bezel button (right bezel) and select System Scanner to discover all stellar bodies. Scanned bodies can be mapped with surface probes for bonus credits, sold at Cartographics.',
    target: { buttonId: 'scanners' },
  },
  {
    id: 'dock',
    title: 'Docking',
    text: 'In the System view, tap a station in the Available Stations panel and press DOCK. Your ship travels and docks automatically. While docked, the bezel buttons switch to station services — [[shipwright]] outfitting, [[market]] trade, [[missionboard]] missions, and more.',
    target: { buttonId: 'station' },
  },
  {
    id: 'station',
    title: 'Station Services',
    text: 'While docked, the top bezel offers [[launch]] to undock, [[shipwright]] for outfitting, [[market]] for trade, and [[missionboard]] for missions. Use the [[save]] bezel button (top bezel) to persist your progress at any time.',
    target: { buttonId: 'shipwright' },
  },
  {
    id: 'dockcam',
    title: 'Dock Camera',
    text: 'Press the [[dockcam]] bezel button (bottom bezel while docked) to watch live starport traffic. Inbound ships circle a holding pattern above the deck, then descend onto numbered pads. Each ship is drawn as a manufacturer-specific silhouette scaled by its class. Tap any ship to identify the pilot and activity. Founder-piloted ships glow green and are rare, special sightings.',
    target: { buttonId: 'dockcam' },
  },
  {
    id: 'outfitting',
    title: 'Shipwright',
    text: 'Press the [[shipwright]] bezel button (top bezel while docked) to buy and equip modules. Browse by category — Core Internals, Optional Internals, Hardpoints, and Utility. Each slot accepts a specific size. Purchase with credits; sell your old module for a partial refund.',
    target: { buttonId: 'shipwright' },
  },
  {
    id: 'fuelscoop',
    title: 'Buying a Fuel Scoop',
    text: 'In the Shipwright, select an empty Optional Internal slot and browse to the Fuel Scoop category. Buy one that fits your slot size. A fuel scoop lets you refuel from suitable stars for free — essential for long-range exploration and saving credits on fuel.',
    target: { buttonId: 'shipwright' },
  },
  {
    id: 'scoop',
  ...
  },
  {
    id: 'missions',
    title: 'Missions',
    text: 'Earn credits by accepting missions from the [[missionboard]] bezel button (top bezel while docked). Missions ask you to deliver cargo, collect bounties, or transport passengers. Higher reputation and rank unlock better-paying missions.',
    target: { buttonId: 'missionboard' },
  },
  {
    id: 'market',
    title: 'Trading',
    text: 'Buy low and sell high at the [[market]] bezel button (top bezel while docked). Each station prices commodities differently based on its economy type. Use [[marketai]] Market Analysis to find profitable trade routes in nearby systems.',
    target: { buttonId: 'market' },
  },
  {
    id: 'settings',
    title: 'Settings',
    text: 'Press the [[settings]] bezel button (top bezel) to customize your experience — color themes, monochrome mode, fonts, audio, controls, and save management. Mini-screen mode and orientation locks help on mobile devices. You can also hide the bezel bars entirely for cyberdeck hardware integration; F1–F24 keys stay active.',
    target: { buttonId: 'settings' },
  },
  {
    id: 'done',
...
const colonizationSteps = [
  ...
  },
  {
    ...
    text: 'Open the [[docked]] quick-action bar > Starport Services > Colonization > Colonies to see all your colonies. Each colony tracks population, infrastructure level, income per cycle, and loyalty. Select a colony to view its details and issue orders — invest credits to upgrade infrastructure, boosting population growth and tax revenue.',
    target: { tab: 'external', folder: 'Colonization', item: 'colonization' },
  },
  {
    id: 'col-system',
    ...
    target: { tab: 'external', folder: 'Navigation', item: 'system' },
  },
  {
    id: 'col-stationbuilder',
    title: 'Station Builder',
    text: 'Open [[external]] > Statuses > Finance > Infrastructure to construct your own stations. Personal stations generate trade revenue, provide docking services, and act as forward bases. Building a station requires credits and materials — the cost scales with the station size and service count.',
    target: { tab: 'external', folder: 'Colonization', item: 'stationbuilder' },
  },
  {
    id: 'col-stationcreator',
    title: 'Station Creator',
    text: 'For full control, open the Station Creator from the Infrastructure screen. Design a custom station from modular parts — choose the hull type, module layout, and service configuration. Custom stations can be placed in any system where you hold a colony or an anchor claim.',
    target: { tab: 'external', folder: 'Colonization', item: 'stationcreator' },
  },
  {
    id: 'col-economy',
...
const carrierSteps = [
  ...
  },
  {
    ...
    text: 'Open [[external]] > Home > Fleet Carriers > Carriers to see all your carriers. Each carrier shows its name, current system, tritium reserves, and cargo usage. Select a carrier to view its full status and access carrier-specific actions. Carriers deployed in your current system appear orbiting in the System view.',
    target: { tab: 'external', folder: 'Carriers', item: 'carriers' },
  },
  {
    id: 'car-logistics',
    title: 'Carrier Logistics',
    text: 'Open [[external]] > Home > Fleet Carriers > Carrier Logistics to manage your carrier operations. Here you load and unload tritium fuel — the carrier consumes tritium for each jump. You also manage cargo holds, set carrier service tariffs, and order resupply. Without tritium, a carrier cannot jump.',
    target: { tab: 'external', folder: 'Carriers', item: 'carrierlogistics' },
  },
  {
    id: 'car-command',
    title: 'Carrier Command',
    text: 'Open [[external]] > Home > Fleet Carriers > Carrier Command to schedule jumps. Select a destination system and set a departure time — carriers jump on a timer, not instantly. You can queue jumps, set the carrier to hold position, or recall it. Plan routes carefully; tritium is expensive and jumps are not free.',
    target: { tab: 'external', folder: 'Carriers', item: 'carriercommand' },
  },
  {
    id: 'car-interior',
    title: 'Carrier Interior',
    text: 'Open [[external]] > Home > Fleet Carriers > Carrier Interior to customize your carrier from the inside out. Build and furnish rooms — crew quarters, aquariums, gardens, genetics labs — each providing bonuses or cosmetic flair. The interior is where your crew lives and where you can host passengers and VIPs.',
    target: { tab: 'external', folder: 'Carriers', item: 'carrierinterior' },
  },
  {
    id: 'car-creator',
    title: 'Carrier Yard',
    text: 'Open [[external]] > Home > Fleet Carriers > Carrier Yard to design and build additional carriers. Custom carriers are assembled from modular parts — hull, drive, superstructure, and interior modules. Each part affects jump range, tritium capacity, and service slots. Building a carrier is a major investment, so plan your design carefully.',
    target: { tab: 'external', folder: 'Carriers', item: 'carriercreator' },
  },
  {
    id: 'car-tritium',
    title: 'Tritium Fuel',
    ...
    target: { tab: 'nav', folder: 'Trade', item: 'market' },
  },
  {
    id: 'car-done',
    title: 'Project Power',
...
const guildedSteps = [
  ...
  },
  {
    ...
    text: 'Open [[external]] > Home > Fleet Carriers > Carrier Command to access guild-specific orders. As the guild flagship owner, you can broadcast jump schedules to all members, set shared cargo access, and designate squadron wingmates from the guild roster. Guild jumps coordinate all member ships traveling with the carrier.',
    target: { tab: 'external', folder: 'Carriers', item: 'carriercommand' },
  },
  {
    id: 'gui-logistics',
    title: 'Shared Logistics',
    text: 'Guilded carriers have expanded cargo and tritium capacity. Use [[external]] > Home > Fleet Carriers > Carrier Logistics to manage the shared hold — guild members can deposit and withdraw resources. Set tariffs for non-members to generate guild income. Tritium contributions from members keep the carrier fueled without personal cost.',
    target: { tab: 'external', folder: 'Carriers', item: 'carrierlogistics' },
  },
  {
    id: 'gui-squadron',
...
const stationBuilderSteps = [
  ...
  },
  {
    id: 'sb-builder',
    title: 'Station Builder',
    text: 'Open [[external]] > Statuses > Finance > Infrastructure to construct additional stations. Choose a station type, select services (market, refuel, repair, outfitting), and place it in a system where you hold a colony. Each service adds revenue but increases the build cost and upkeep.',
    target: { tab: 'external', folder: 'Colonization', item: 'stationbuilder' },
  },
  {
    id: 'sb-creator',
    title: 'Station Creator',
    text: 'For custom designs, open the Station Creator from the Infrastructure screen. Assemble a station from modular parts — hull type, docking bays, service modules, and defense systems. Custom stations can match your exact needs, from a minimal refuel outpost to a full-service starport.',
    target: { tab: 'external', folder: 'Colonization', item: 'stationcreator' },
  },
  {
    id: 'sb-revenue',
...
const customShipSteps = [
  ...
  },
  {
    id: 'cs-yard',
    title: 'Ship Yard',
    text: 'Open [[external]] > Home > Fleet > Shipyard to design and build ships. Select a hull class, then add a cockpit, internal modules, hardpoints, and utility mounts. Each part affects mass, jump range, speed, armor, and shield. The live stat readout updates as you build so you can balance your design.',
    target: { tab: 'external', folder: 'Ship', item: 'shipcreator' },
  },
  {
    id: 'cs-building',
    title: 'Building Process',
    text: 'Custom ships require credits and materials to build. Once assembled, the ship appears in your stored fleet. Switch to it from the Ship panel ([[external]] > Ship) while docked. Your previous ship goes into storage — you can switch back any time at no cost.',
    target: { tab: 'external', folder: 'Ship', item: 'ship' },
  },
  {
    id: 'cs-flying',
  ...
  },
  {
    ...
    text: 'Custom ships are the ultimate expression of a commander style — a heavy-armored miner, a stripped-down racer, a long-range explorer. Experiment with designs, save loadout presets ([[external]] > Home > Fleet > Loadout Presets), and find the ship that fits you. Replay this guide anytime from the Codex.',
    target: { tab: 'external', folder: 'Ship', item: 'presets' },
  },
];
...
const engineeringSteps = [
  ...
  },
  {
    ...
    text: 'Open the [[docked]] quick-action bar > Starport Services > Engineering while docked at a station with an engineer. The left panel lists every equipped module. Select one to see its available blueprints. Each blueprint has multiple grades — higher grades give bigger bonuses but cost more materials.',
    target: { tab: 'external', folder: 'Modules', item: 'engineering' },
  },
  {
    id: 'eng-blueprints',
  ...
  },
  {
    ...
    text: 'Upgrading costs credits and materials — raw, manufactured, and encoded. Materials are consumed permanently. Use the [[docked]] quick-action bar > Starport Services > Material Trader to exchange materials you have for ones you need. The cost panel shows exactly what each upgrade requires and highlights what you are missing in red.',
    target: { tab: 'external', folder: 'Modules', item: 'materialtrader' },
  },
  {
    id: 'synthesis',
    title: 'Synthesis',
    text: 'Open [[external]] > Inventory > Synthesis to craft temporary consumable buffs — ammo, FSD injections, heat sinks, and more — from materials. Unlike engineering, synthesis is single-use and does not permanently alter your modules. Keep a stock of synthesized ammo and FSD boosts for long expeditions.',
    target: { tab: 'external', folder: 'Modules', item: 'synthesis' },
  },
  {
    id: 'eng-done',
...
const combatSteps = [
  ...
  },
  {
    id: 'cmb-bounty',
    title: 'Bounty Board',
    text: 'Open [[nav]] > Transactions > Bounty Claims while docked to accept kill contracts. Each bounty lists a target, a reward, and a system. Bounty vouchers are awarded automatically when you destroy a wanted ship — cash them at any station with Cartographics or the Bounty Board.',
    target: { tab: 'nav', folder: 'Missions', item: 'bountyboard' },
  },
  {
    id: 'cmb-conflict',
  ...
  },
  {
    ...
    text: 'A combat ship needs shield boosters, hull reinforcement, and high-DPS hardpoints. Outfit at the [[docked]] quick-action bar > Starport Services > Outfitting, then engineer your weapons and shields at Engineering. Carry shield cells or heat sinks. Never fight in a stock ship against engineered opponents.',
    target: { tab: 'external', folder: 'Modules', item: 'outfitting' },
  },
  {
    id: 'cmb-done',
    title: 'Fly Dangerous',
...
const miningSteps = [
  ...
  },
  {
    ...
    text: 'Mined fragments go to your refinery, which processes them into cargo. Raw and manufactured materials are stored in your materials locker — not cargo. Use the [[docked]] quick-action bar > Starport Services > Material Trader to exchange unwanted materials for ones you need for engineering and synthesis.',
    target: { tab: 'external', folder: 'Modules', item: 'materialtrader' },
  },
  {
    id: 'min-done',
...
const crewSteps = [
  ...
  },
  {
    id: 'crw-crew',
    title: 'Crew Quarters',
    text: 'Open the [[docked]] quick-action bar > Starport Services > Crew while docked to hire NPC crew. Active crew provide passive bonuses — a combat pilot increases weapon damage, an engineer boosts shield recharge, a trader improves market prices. Crew take a percentage of your earnings as salary, so hire wisely.',
    target: { tab: 'nav', folder: 'Personnel', item: 'crew' },
  },
  {
    id: 'crw-multicrew',
    title: 'Multi-Crew',
...
const missionsSteps = [
  ...
  },
  {
    id: 'msn-board',
    title: 'Mission Board',
    text: 'Open [[nav]] > Transactions > Missions while docked to see available contracts. Missions include delivery, courier, mining, passenger transport, and bounty hunting. Each lists a destination, reward, and deadline. Accept missions whose destination systems you can reach in time — failing a mission damages your reputation.',
    target: { tab: 'nav', folder: 'Missions', item: 'missions' },
  },
  {
    id: 'msn-chains',
    title: 'Mission Chains',
    text: 'Open [[nav]] > Transactions > Missions to follow multi-part story arcs. Completing a chain grants escalating rewards and unlocks unique reputation opportunities. Chains connect across multiple systems — follow the prompts to each destination in sequence.',
    target: { tab: 'nav', folder: 'Missions', item: 'chains' },
  },
  {
    id: 'msn-passengers',
    title: 'Passenger Lounge',
    text: 'Open [[nav]] > Transactions > Passengers while docked to accept passenger missions. Passengers need cabin space — install passenger cabins in optional internal slots via Outfitting. VIP passengers pay more but demand specific cabin classes and may refuse if your reputation is too low.',
    target: { tab: 'nav', folder: 'Personnel', item: 'passengers' },
  },
  {
    id: 'msn-trade-tools',
    title: 'Trade Tools',
    text: 'Open [[external]] > Statuses > Finance > Trade Tools to find profitable routes. Enter your cargo capacity and the tool suggests buy-low, sell-high loops between nearby stations. It accounts for commodity prices and distances, letting you maximize profit per ton per light year.',
    target: { tab: 'nav', folder: 'Trade', item: 'trade' },
  },
  {
    id: 'msn-analysis',
    title: 'Market Analysis',
    text: 'Open the [[docked]] quick-action bar > Trade > Market Analysis for AI-driven trade route recommendations. It scans nearby markets for the best margins and trends, suggesting where to buy and sell for maximum profit. Use it alongside Trade Tools to validate routes before committing your cargo.',
    target: { tab: 'nav', folder: 'Trade', item: 'marketai' },
  },
  {
    id: 'msn-blackmarket',
    title: 'Black Market',
    text: 'Open the [[docked]] quick-action bar > Starport Services > Black Market at stations with one (found in low-security and anarchy systems) to sell stolen or illegal goods. Black market prices are lower than legal markets, but it is the only way to offload pirated cargo. Selling here raises your wanted status — manage your crime record carefully.',
    target: { tab: 'nav', folder: 'Trade', item: 'blackmarket' },
  },
  {
    id: 'msn-company',
    title: 'Company',
    text: 'Open [[external]] > Statuses > Finance > Company to manage your corporate faction. As you grow, you can found a company that holds assets, issues dividends, and competes with NPC factions for system influence. Company growth ties into the BGS (Background Simulation) — influence drives control of stations and systems.',
    target: { tab: 'nav', folder: 'Trade', item: 'company' },
  },
  {
    id: 'msn-done',
...
const explorationSteps = [
  ...
  },
  {
    ...
    text: 'Open [[nav]] > Navigation > Galaxy Map for the exploration dashboard. It tracks your scan count, total payout, and current system survey status. Run an FSS scan in each new system to populate the system map, then probe landable bodies for detailed data.',
    target: { tab: 'external', folder: 'Data', item: 'exploration' },
  },
  {
    id: 'exp-fss',
    title: 'FSS Scanner',
  ...
  },
  {
    id: 'exp-cartography',
    title: 'Cartographics',
    text: 'Open the [[docked]] quick-action bar > Starport Services > Cartographics while docked to sell your scan data. You only get paid when you sell — and you lose all unsold data if your ship is destroyed. Always return to a station and cash in before risking your ship. First discoveries earn a bonus and your name on the body.',
    target: { tab: 'external', folder: 'Data', item: 'cartography' },
  },
  {
    id: 'exp-discoveries',
    title: 'Discoveries Database',
    text: 'Open [[external]] > Home > Codex > Discoveries to review every body you have first-discovered. The database logs your name, the body, and the scan value. It is your permanent record of exploration — even after selling the data, the discovery credits remain.',
    target: { tab: 'external', folder: 'Reference', item: 'discoveries' },
  },
  {
    id: 'exp-done',
...
const commanderSteps = [
  {
    ...
    text: 'Your commander is more than a pilot — a reputation, a rank, a collection of titles and achievements. This guide covers the [[external]] > Home tab: your profile, ranks, reputation, titles, badges, and the competitive leaderboards.',
    target: null,
  },
  {
    id: 'cmd-profile',
    title: 'Commander Profile',
    text: 'Open [[external]] > Home > Player Identity > Profile to see your commander record: total earnings, light years traveled, jumps, kills, and ranks across trade, combat, exploration, and mining. The profile is your permanent stat sheet — it persists across ship losses and grows throughout your career.',
    target: { tab: 'external', folder: 'Identity', item: 'profile' },
  },
  {
    id: 'cmd-ranks',
    title: 'Ranks & Reputation',
    text: 'Open [[external]] > Home > Player Identity > Reputation to view your standing with every faction and superpower you have interacted with. Higher reputation unlocks better missions, higher payouts, and access to restricted systems. Reputation rises by completing missions and bounties for a faction; it falls if you attack their ships or fail their missions.',
    target: { tab: 'external', folder: 'Identity', item: 'rep' },
  },
  {
    id: 'cmd-titles',
    title: 'Titles',
    text: 'Open [[external]] > Home > Player Identity > Titles to view and equip earned titles. Titles are displayed alongside your name and reflect milestones — combat ranks, exploration achievements, faction allegiance. Equip one to show your status to other commanders and in your profile.',
    target: { tab: 'external', folder: 'Identity', item: 'titles' },
  },
  {
    id: 'cmd-badges',
    title: 'Badge Maker',
    text: 'Open [[external]] > Home > Player Identity > Badge Maker to create custom badges from your achievements. Combine unlocked icons and colors into a personal emblem. Badges are cosmetic but let you express your commander identity — collect the components by completing specific achievement milestones.',
    target: { tab: 'external', folder: 'Identity', item: 'badgemaker' },
  },
  {
    id: 'cmd-achievements',
    title: 'Awards & Achievements',
    text: 'Open [[external]] > Home > Ranks > Awards to see every achievement and your progress toward each. Achievements reward credits, materials, and titles. Some are milestone-based (jumps, kills, credits); others are discovery-based (first carrier, first colony). Check back often — new achievements unlock as you progress.',
    target: { tab: 'external', folder: 'Progress', item: 'achievements' },
  },
  {
    id: 'cmd-leaderboard',
    title: 'Leaderboard',
    text: 'Open [[external]] > Home > Ranks > Leaderboard to compare your stats against other commanders. Leaderboards track total credits, jumps, kills, exploration value, and more. Climb the ranks by playing more — the leaderboard updates as your stats grow.',
    target: { tab: 'external', folder: 'Progress', item: 'leaderboard' },
  },
  {
    id: 'cmd-codex',
    title: 'Codex',
    text: 'Open [[external]] > Home > Codex > Codex anytime to look up any game mechanic. The Codex is the complete in-game encyclopedia — including this Tutorials category, where you can replay any guide. Bookmark it; it is your reference for everything in the galaxy.',
    target: { tab: 'external', folder: 'Reference', item: 'codex' },
  },
  {
    id: 'cmd-done',
...
const galaxySteps = [
  ...
  },
  {
    ...
    text: 'Open [[external]] > Statuses > System Factions to track the Background Simulation — the system that models faction influence and control. Factions gain influence through missions, trade, and bounties done in their systems. High influence can trigger wars and elections that shift station ownership. Your actions move the needle.',
    target: { tab: 'nav', folder: 'World', item: 'bgs' },
  },
  {
    id: 'gal-powerplay',
    title: 'Power Play',
    text: 'Open [[external]] > Home to pledge allegiance to a galactic power. Powers are major figures who control vast territory. Pledge to one, complete their objectives, and earn rank rewards — unique modules, salary, and system access. Pledging is a commitment; switching powers resets your progress.',
    target: { tab: 'nav', folder: 'World', item: 'powerplay' },
  },
  {
    id: 'gal-crime',
    title: 'Crime Status',
    text: 'Open [[nav]] > Transactions > Fines & Personal Bounties to view your wanted level and active bounties. Crimes — piracy, murder, smuggling — generate fines and bounties on your head. Pay fines at any station; clear bounties at an Interstellar Factors in a low-security system. A clean record keeps security forces friendly.',
    target: { tab: 'nav', folder: 'World', item: 'crime' },
  },
  {
    id: 'gal-galnet',
    title: 'StarNet News',
    text: 'Open [[external]] > Home > News for the galactic news feed. Articles cover faction conflicts, power shifts, market events, and cosmic phenomena. Reading Galnet keeps you informed of where the action is — a war starting in a nearby system may mean combat bonds and trade disruption.',
    target: { tab: 'nav', folder: 'World', item: 'galnet' },
  },
  {
    id: 'gal-goals',
    title: 'Community Goals',
    text: 'Open [[external]] > Home > Codex > World > Community Goals to join time-limited server-wide objectives. Contribute commodities, combat bonds, or exploration data to a shared goal. When the community fills the meter, all contributors receive tiered rewards — the more you contribute, the bigger your cut. Goals reset on a timer.',
    target: { tab: 'nav', folder: 'World', item: 'goals' },
  },
  {
    id: 'gal-holidays',
    title: 'Public Holidays',
    text: 'Open [[nav]] > Transactions > Holidays to see the real-calendar holiday system. On public holidays, special effects activate — fuel discounts, bonus payouts, increased traffic. Holidays run on a two-week countdown; plan your trading and refueling around them to save credits.',
    target: { tab: 'nav', folder: 'World', item: 'holidays' },
  },
  {
    id: 'gal-events',
    title: 'Cosmic Events',
    text: 'Open [[external]] > Home > Codex > World > Cosmic Events for server-wide timed events — double payouts, material showers, faction flashpoints. Events are time-limited and often tie to holidays or narrative arcs. Participate while they last for bonus rewards you cannot get otherwise.',
    target: { tab: 'nav', folder: 'World', item: 'events' },
  },
  {
    id: 'gal-done',
...
const cabinSteps = [
  {
    id: 'cab-welcome',
    title: 'Cabin Life',
    text: 'Beyond the cockpit, your ship or carrier can house living spaces — cabins, aquariums, gardens, and labs. These provide passive bonuses, cosmetic flair, and specimen collection. This guide covers the cabin systems under the [[external]] tab.',
    target: null,
  },
  {
    id: 'cab-cabin',
    title: 'Cabin',
    text: 'Open [[external]] > Ship > Ship Cabin > Cabin to view and enter your ship cabin. The cabin is your personal space — furnished with rooms you build. From here you can walk around, view your collections, and manage your living quarters. Cabin modules are installed in optional internal slots via Outfitting.',
    target: { tab: 'external', folder: 'Cabin', item: 'cabin' },
  },
  {
    id: 'cab-rooms',
    title: 'Room Manager',
    text: 'Open [[external]] > Ship > Ship Cabin > Room Manager to build and arrange rooms in your cabin or carrier interior. Each room type — quarters, lounge, lab, greenhouse — provides different bonuses or functions. Place rooms to fit your playstyle; the layout is fully customizable and saved per ship or carrier.',
    target: { tab: 'external', folder: 'Cabin', item: 'roommanager' },
  },
  {
    id: 'cab-aquarium',
    title: 'Aquarium',
    text: 'Open [[external]] > Ship > Ship Cabin > Aquarium to collect and display aquatic specimens caught during your travels. Fish are procedurally generated with unique traits. A stocked aquarium provides a small morale bonus to crew and is a living record of the worlds you have visited. Catch fish with specialized equipment on water worlds.',
    target: { tab: 'external', folder: 'Cabin', item: 'aquarium' },
  },
  {
    id: 'cab-garden',
    title: 'Garden',
    text: 'Open [[external]] > Ship > Ship Cabin > Garden to cultivate flora collected from habitable planets. Plants grow over time and provide materials, oxygen, or morale bonuses. A well-tended garden is both decorative and functional — harvest it periodically for usable resources.',
    target: { tab: 'external', folder: 'Cabin', item: 'garden' },
  },
  {
    id: 'cab-genetics',
    title: 'Genetics Lab',
    text: 'Open [[external]] > Ship > Ship Cabin > Genetics Lab to crossbreed specimens from your aquarium and garden. Combining traits can produce rare and valuable new species. The genetics lab is the endgame of specimen collection — experiment with pairings to discover unique organisms worth credits and achievements.',
    target: { tab: 'external', folder: 'Cabin', item: 'geneticslab' },
  },
  {
    id: 'cab-done',
    title: 'Make It Home',
...
const infrastructureSteps = [
  {
    ...
    text: 'As you progress, you can build infrastructure that benefits you and other commanders — warp gates for instant travel and allegiance to the Canis Stella megacorporation. This guide covers these endgame systems under the [[external]] tab.',
    target: null,
  },
  {
    id: 'inf-warpgates',
    title: 'Warp Gates',
    text: 'Open [[external]] > Home > Fleet > Warp Gates to construct permanent fast-travel links between systems. A warp gate allows instant jumps between two linked systems, bypassing fuel and range costs. Building a gate requires significant credits and rare materials, but it permanently shortcuts a route you travel often.',
    target: { tab: 'external', folder: 'Infrastructure', item: 'warpgates' },
  },
  {
    id: 'inf-canis',
    title: 'Canis Stella',
    text: 'Open [[external]] > Home > Factions > Canis Stella to engage with the Canis Stella corporation — a player-facing megacorp with its own rank structure, CEO title, and corporate missions. Climb the corporate ladder by completing Canis Stella objectives. The top rank grants the CEO title and control of corporate policy.',
    target: { tab: 'external', folder: 'Infrastructure', item: 'canisstella' },
  },
  {
    id: 'inf-done',
...
const maintenanceSteps = [
  ...
  },
  {
    ...
    text: 'Open the [[docked]] quick-action bar > Starport Services > Advanced Maintenance while docked to repair worn modules. Modules accumulate wear from use — thrusters, FSD, and weapons degrade fastest. Worn modules perform worse and cost more to repair the longer you wait. Run maintenance regularly to keep your ship at peak performance.',
    target: { tab: 'external', folder: 'Modules', item: 'maintenance' },
  },
  {
    id: 'mnt-ship',
    title: 'Ship Panel',
    text: 'Open [[external]] > Ship > Functions for your vessel dashboard — stats, cargo manifest, materials locker, shipyard, and outfitting access. Monitor your hull integrity, fuel, and cargo here. The ship panel is your command center for everything about your current vessel.',
    target: { tab: 'external', folder: 'Ship', item: 'ship' },
  },
  {
    id: 'mnt-presets',
    title: 'Loadout Presets',
    text: 'Open [[external]] > Home > Fleet > Loadout Presets to save and recall module configurations. Save a combat build, an exploration build, and a trade build, then swap between them at a station with one click (modules must be in your storage). Presets save time when switching roles — never re-outfit from scratch again.',
    target: { tab: 'external', folder: 'Ship', item: 'presets' },
  },
  {
    id: 'mnt-rebuy',
...
const salvageSteps = [
  ...
  { id: 'salvage-open', title: 'Open the Salvage Screen', text: 'Open the Salvage panel to review the wreck your scanners detected in this system.', target: { tab: 'external', folder: 'Data', item: 'wreckage' } },
  { id: 'salvage-collect', title: 'Salvage the Wreck', text: 'Press SALVAGE WRECK to recover the unique components aboard. They are stored in your Salvaged Components locker, separate from regular materials.', target: { tab: 'external', folder: 'Data', item: 'wreckage' } },
  { id: 'salvage-sell', title: 'Sell for Credits', text: 'Collected components can be sold for credits anytime from the Salvage screen — rarer components are worth far more. Keep exploring to find legendary wrecks.', target: { tab: 'external', folder: 'Data', item: 'wreckage' } },
];
...
const cardsSteps = [
  ...
  },
  {
    id: 'crd-binder',
    title: 'The Binder',
    text: 'Open [[external]] > Home > Player Identity > Profile and switch to the Cards tab to view your binder. Each deck shows your collection progress. Sort by number, power, name, or rarity; filter by rarity; or toggle "Missing only" to find gaps. Tap a card you own for full stats and flavor.',
    target: { tab: 'external', folder: 'Identity', item: 'profile' },
  },
  {
    id: 'crd-grant',
