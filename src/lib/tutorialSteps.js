...
const starterSteps = [
  ...
  },
  {
    ...
    text: 'The top bar holds five tabs. [[nav]]: navigation, transactions, and contacts. [[external]]: your ship, modules, inventory, home, and statuses. [[deploy]]: deployed craft like fighters and SRV. [[comms]]: your comms log. [[settings]]: display and controls. While docked, a quick-action bar appears with Starport Services, Launch, Trade, and Dock Camera. Tap a tab to open its folder list.',
    target: { tab: 'external' },
  },
  {
    id: 'galaxy',
    title: 'Galaxy Map',
    text: 'Open [[nav]] > Navigation > Galaxy Map to view the galaxy. Tap any star to select it, then plot a route — your ship jumps system to system. Fuel and jump range are checked automatically before each jump.',
    target: { tab: 'external', folder: 'Navigation', item: 'galaxy' },
  },
  {
    id: 'system',
    title: 'System View',
  ...
  },
  {
    id: 'fss',
    title: 'FSS Scanner',
    text: 'When you arrive in a new system, run the FSS Scanner (button at the bottom of the celestial body list) to discover all stellar bodies. Scanned bodies can be mapped with surface probes for bonus credits, sold at Cartographics.',
    target: { tab: 'external', folder: 'Scanning', item: 'fss' },
  },
  {
    id: 'dock',
    title: 'Docking',
    text: 'To dock, open the [[docked]] quick-action bar > Starport Services while docked. Tap a station in the Available Stations panel and press DOCK. Your ship travels and docks automatically. Station services — refuel, repair, market, outfitting — are only available while docked.',
    target: { tab: 'nav', item: 'station' },
  },
  {
    id: 'station',
  ...
  },
  {
    id: 'dockcam',
    title: 'Dock Camera',
    text: 'Open the [[docked]] quick-action bar > Dock Camera to watch live starport traffic. Inbound ships circle a holding pattern above the deck, then descend onto numbered pads. Each ship is drawn as a manufacturer-specific silhouette scaled by its class. Tap any ship to identify the pilot and activity. Every NPC commander is procedurally generated and unique on screen — you will not see the same pilot twice while they are present. Founder-piloted ships glow green and are rare, special sightings.',
    target: { tab: 'nav', item: 'dockcam' },
  },
  {
    id: 'outfitting',
    title: 'Outfitting',
    text: 'Open the [[docked]] quick-action bar > Starport Services > Outfitting to buy and equip modules. Browse by category — Core Internals, Optional Internals, Hardpoints, and Utility. Each slot accepts a specific size. Purchase with credits; sell your old module for a partial refund.',
  ...
  },
  {
    id: 'missions',
    title: 'Missions',
    text: 'Earn credits by accepting missions from the [[docked]] quick-action bar > Starport Services > Mission Board while docked. Missions ask you to deliver cargo, collect bounties, or transport passengers. Higher reputation and rank unlock better-paying missions.',
    target: { tab: 'nav', folder: 'Missions', item: 'missions' },
  },
  {
    id: 'market',
    title: 'Trading',
    text: 'Buy low and sell high at the [[docked]] quick-action bar > Trade > Market. Each station prices commodities differently based on its economy type. Use Market Analysis to find profitable trade routes in nearby systems.',
